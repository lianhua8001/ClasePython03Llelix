...
- Crear una una variable llamada nombre_completo
  para almacenar el nombre completo en todo en ma yuscula 
  que usted debe ingresar por consola con la función input.
...
nombre_completo=str(input("Introduzca su nombre completo en mayúscula:"))
